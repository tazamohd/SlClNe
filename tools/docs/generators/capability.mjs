...
export function generateCapability(model) {
  ...
  write(
    ...
    [
      ...
      '',
      `**Status:** GENERATED · **Generated:** ${model.generatedAt} · ${model.capabilities.length} capabilities`,
      '',
  ...
  write(
    ...
    [
      ...
      '# Screen registry',
      '',
      `**Status:** GENERATED (a view over a registry this documentation does not own) · **Generated:** ${model.generatedAt}`,
      '',
