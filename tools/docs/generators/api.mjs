...
export function generateApi(model) {
  ...
  const overview = [
    ...
    '# API overview',
    '',
    `**Status:** GENERATED · **Source of truth:** the route files · **Sources as of:** ${model.generatedAt}`,
    '',
  ...
  for (const [domain, list] of Object.entries(byDomain)) {
    write(
      ...
      [
        ...
        `# API — ${domain}`,
        '',
        `**Status:** GENERATED · **Sources as of:** ${model.generatedAt} · ${list.length} endpoints`,
        '',
        table(
  ...
  write(
    ...
    [
      ...
      '# RBAC matrix',
      '',
      `**Status:** GENERATED · **Source of truth:** \`packages/contract/src/rbac.ts\` · **Sources as of:** ${model.generatedAt}`,
      '',
  ...
  write(
    ...
    [
      ...
      '',
      `**Status:** GENERATED · **Source of truth:** the migrations · **Sources as of:** ${model.generatedAt}`,
      '',
      '## Position',
      '',
