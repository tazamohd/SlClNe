...
export function generateRelease(model, requirements, trace, controlStats) {
  ...
  write(
    ...
    [
      ...
      '# Production readiness',
      '',
      `**Generated:** ${model.generatedAt} · **${met} of ${criteria.length} criteria met**`,
      '',
  ...
  write(
    ...
    [
      ...
      '# Documentation certification',
      '',
      `**Generated:** ${model.generatedAt} · **Score: ${total} / 100**`,
      '',
      '## What this score is',
      '',
  ...
  write(
    ...
    [
      ...
      '',
      `**Generated:** ${model.generatedAt} · ${inline.reduce((s, d) => s + d.count, 0)} diagrams across ${inline.length} documents`,
      '',
      '## Format',
      '',
