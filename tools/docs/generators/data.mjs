...
export function generateData(model) {
  ...
  write(
    ...
    [
      ...
      '# Entity catalogue',
      '',
      `**Status:** GENERATED · **Source of truth:** \`server/src/db/schema.ts\` · **Sources as of:** ${model.generatedAt}`,
      '',
  ...
  for (const [domain, tables] of Object.entries(DOMAIN_TABLES)) {
    ...
    write(
      ...
      [
        ...
        `# ${domain} ERD`,
        '',
        `**Status:** GENERATED · **Sources as of:** ${model.generatedAt} · ${present.length} tables`,
        '',
