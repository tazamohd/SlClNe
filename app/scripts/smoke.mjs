...
const EXPECTED_TEXT = {
  ...
  '/invite-acceptance': "InviteAcceptance",
  '/invoice-preview': "InvoicePreview",
  '/kiosk-check-in': "KioskCheckIn",
  '/lead-detail': "LeadDetail",
  '/loan-reports': "LoanReports",
  '/logout-confirmation': "LogoutConfirmation",
  '/model-settings': "ModelSettings",
  '/native/android': "Native · Android",
  '/native/i-os': "Native · iOS",
  '/notification-center': "NotificationCenter",
  '/obddiagnostics': "OBDDiagnostics",
  '/oemintegrations': "OEMIntegrations",
  '/organizations': "Organizations",
  '/organization-selection': "OrganizationSelection",
  '/profile-completion': "ProfileCompletion",
  '/prompt-library': "PromptLibrary",
  '/public-portal/about': "PublicPortal · About",
  '/public-portal/accounting': "PublicPortal · Accounting",
  '/public-portal/ai': "PublicPortal · AI",
  '/public-portal/automation': "PublicPortal · Automation",
  '/public-portal/blog': "PublicPortal · Blog",
  '/public-portal/book-demo': "PublicPortal · BookDemo",
  '/public-portal/careers': "PublicPortal · Careers",
  '/public-portal/contact': "PublicPortal · Contact",
  '/public-portal/crm': "PublicPortal · CRM",
  '/public-portal/customer-portal': "PublicPortal · CustomerPortal",
  '/public-portal/faq': "PublicPortal · FAQ",
  '/public-portal/features': "PublicPortal · Features",
  '/public-portal/fleet': "PublicPortal · Fleet",
  '/public-portal/industries': "PublicPortal · Industries",
  '/public-portal/insurance': "PublicPortal · Insurance",
  '/public-portal/integrations': "PublicPortal · Integrations",
  '/public-portal/landing': "PublicPortal · Landing",
  '/public-portal/loans': "PublicPortal · Loans",
  '/public-portal/mini-erp': "PublicPortal · MiniERP",
  '/public-portal/parts-accessories': "PublicPortal · PartsAccessories",
  '/public-portal/deals-offers': "PublicPortal · DealsOffers",
  '/public-portal/pricing': "PublicPortal · Pricing",
  '/public-portal/products': "PublicPortal · Products",
  '/public-portal/request-demo': "PublicPortal · RequestDemo",
  '/public-portal/resources': "PublicPortal · Resources",
  '/public-portal/services': "PublicPortal · Services",
  '/public-portal/solutions': "PublicPortal · Solutions",
  '/public-portal/spare-parts': "PublicPortal · SpareParts",
  '/public-portal/supplier-portal': "PublicPortal · SupplierPortal",
  '/public-portal/support': "PublicPortal · Support",
  '/public-portal/technician-portal': "PublicPortal · TechnicianPortal",
  '/public-portal/workshop': "PublicPortal · Workshop",
  ...
  '/ssologin': "SSOLogin",
  '/supplier-portal/orders': "SupplierPortal · Orders",
  '/system-integrations': "SystemIntegrations",
  '/technician-kb': "TechnicianKB",
  '/technician-portal/job-detail': "TechnicianPortal · JobDetail",
  '/templates': "Templates",
  '/users-teams': "UsersTeams",
  '/vehicle-detail': "VehicleDetail",
  '/whats-app-campaigns': "WhatsAppCampaigns",
  ...
  '/towing-assistance': "Towing Assistance",
  '/towing-services': "Towing Services",
  '/telematics-integration': "Telematics Integration",
  '/digital-vehicle-walkaround': "Digital Vehicle Walkaround",
  '/predictive-diagnostics': "Predictive Diagnostics",
  '/oem-software-subscriptions': "OEM Software Subscriptions",
  '/service-bay-dashboard': "Service Bay Dashboard",
  '/live-service-tracking': "Live Service Tracking",
  '/computer-vision-qc': "Computer Vision QC",
  '/refund-management': "Refund Management",
  '/inventory-management': "Inventory Management",
  '/parts-availability': "Parts Availability",
  '/parts-auto-reorder': "Parts Auto Reorder",
  '/smart-parts-recommender': "Smart Parts Recommender",
  '/smart-parts-recommendations': "Smart Parts Recommendations",
  '/smart-inventory-forecasting': "Smart Inventory Forecasting",
  '/spare-parts': "Spare Parts",
  '/internal-warehouse': "Internal Warehouse",
  '/interactive-3-d-parts': "Interactive 3D Parts",
  '/dynamic-pricing': "Dynamic Pricing",
  '/intelligent-price-optimizer': "Intelligent Price Optimizer",
  '/suppliers': "Suppliers",
  '/vendor-supplier-portal': "Vendor Supplier Portal",
  '/parts-network-dashboard': "Parts Network Dashboard",
  '/parts-network-my-requests': "Parts Network My Requests",
  '/parts-network-incoming-requests': "Parts Network Incoming Requests",
  '/purchase-agent-dashboard': "Purchase Agent Dashboard",
  '/purchase-agent-tasks': "Purchase Agent Tasks",
  '/purchase-agent-quotations': "Purchase Agent Quotations",
  '/purchase-agent-payments': "Purchase Agent Payments",
  '/purchase-agent-delivery': "Purchase Agent Delivery",
  '/purchase-agent-orders': "Purchase Agent Orders",
  '/purchase-agent-suppliers': "Purchase Agent Suppliers",
  '/purchase-agent-inventory': "Purchase Agent Inventory",
  '/purchase-agent-price-compare': "Purchase Agent Price Compare",
  '/purchase-agent-tracking': "Purchase Agent Tracking",
  '/purchase-agent-reports': "Purchase Agent Reports",
  '/technician-portal-dashboard': "Technician Portal Dashboard",
  '/technician-portal-my-jobs': "Technician Portal My Jobs",
  '/technician-portal-time-clock': "Technician Portal Time Clock",
  '/technician-portal-parts': "Technician Portal Parts",
  '/technician-portal-documentation': "Technician Portal Documentation",
  '/technician-portal-profile': "Technician Portal Profile",
  '/technician-portal-attendance': "Technician Portal Attendance",
  '/technician-portal-guides': "Technician Portal Guides",
  '/technician-portal-software': "Technician Portal Software",
  '/technician-leaderboards': "Technician Leaderboards",
  '/technician-performance': "Technician Performance",
  '/technician-app-home': "Technician App Home",
  '/technician-app-jobs': "Technician App Jobs",
  '/technician-app-clock': "Technician App Clock",
  '/technician-app-lookup': "Technician App Lookup",
  '/technician-app-profile': "Technician App Profile",
  '/client-portal-dashboard': "Client Portal Dashboard",
  '/client-portal-vehicles': "Client Portal Vehicles",
  '/client-portal-appointments': "Client Portal Appointments",
  '/client-portal-invoices': "Client Portal Invoices",
  '/client-portal-profile': "Client Portal Profile",
  '/client-portal-service-history': "Client Portal Service History",
  '/client-portal-live-tracking': "Client Portal Live Tracking",
  '/client-portal-reminders': "Client Portal Reminders",
  '/client-portal-review-chat': "Client Portal Review Chat",
  '/customer-app-booking': "Customer App Booking",
  '/customer-app-vehicles': "Customer App Vehicles",
  '/customer-app-payments': "Customer App Payments",
  '/portal-dashboard': "Portal Dashboard",
  '/portal-appointments': "Portal Appointments",
  '/portal-invoices': "Portal Invoices",
  '/portal-vehicles': "Portal Vehicles",
  '/portal-communications': "Portal Communications",
  '/profit-analysis': "Profit Analysis",
  '/kpi-dashboard': "KPI Dashboard",
  '/productivity-tracker': "Productivity Tracker",
  '/staff-directory': "Staff Directory",
  '/staff-scheduling': "Staff Scheduling",
  '/staff-performance-review': "Staff Performance Review",
  '/timesheet-management': "Timesheet Management",
  '/timeclock-payroll': "Timeclock Payroll",
  ...
  '/support-chat-dashboard': "Support Chat Dashboard",
...
Object.assign(EXPECTED_TEXT, {
  ...
  '/public-portal/parts-accessories': 'Parts & Accessories',
  '/public-portal/deals-offers': 'Deals & Offers',
