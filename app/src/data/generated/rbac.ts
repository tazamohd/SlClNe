...
// the "HealthCheckReport": "jobcards" / "CannedJobs": "estimates" entries in
// SCREEN_MODULE, were added by hand alongside the matching FIELD_RULES entry
// in project/gms-data.js (DVHC, Sprint 2, P0; Canned Jobs, build-order item
// 5 — neither screen has a design source, same reasoning as "DeclinedJobs"
...
export const RBAC_UNGATED: readonly string[] = [
  "Index",
  "RBACSpec",
  "FlowSpec",
  "UI.EmptyStates",
...
export const SCREEN_MODULE: Record<string, string> = {
...
export const FIELD_RULES: readonly FieldRule[] = [
  ...
  {
    "field": "Inspection internal notes",
    "ar": "ملاحظات الفحص الداخلية",
    "hidden": [
      "customer",
      "supplier"
    ]
...
export const SOD: readonly SodRule[] = [
  {
