...
const STATUS_PALETTE: Record<string, { bg: string; fg: string }> = {
  ...
  Exceeding: { bg: 'rgba(234,88,12,.1)', fg: 'var(--salis-orange-hover)' },
}
            ...
            <MobileCardHeader
              leading={
                <div className="flex items-center gap-2">
                  <span className="flex rounded-lg p-1.5 bg-tint-blue text-salis-blue" aria-hidden><Icon name="Leaf" size={14} /></span>
                  <div>
