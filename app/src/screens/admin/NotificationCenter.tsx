...
function useNotifications(t: (s: string) => string) {
  return useMemo<Notification[]>(() => [
    { id: 1, icon: 'Wrench', title: t('New Job Card Created'), body: 'JC-E5D7A3B5 — Sara Al-Mutairi · Ford Explorer 2022', time: t('just now'), category: 'jobs', categoryLabel: t('Job Cards'), iconBg: 'rgba(10,94,215,.1)', categoryBg: 'rgba(10,94,215,.1)', categoryFg: 'var(--salis-blue)', unread: true },
    { id: 2, icon: 'Calendar', title: t('Appointment Confirmed'), body: 'Ahmed Al-Rashid — ' + t('Maintenance') + ' · Jul 23, 9:00 AM', time: '5 ' + t('minutes ago'), category: 'appointments', categoryLabel: t('Appointments'), iconBg: 'rgba(11,179,255,.1)', categoryBg: 'rgba(11,179,255,.1)', categoryFg: 'var(--salis-blue-bright)', unread: true },
    { id: 3, icon: 'AlertTriangle', title: t('Invoice Overdue'), body: 'INV-2026-0141 — Fatima Al-Zahrani · SAR 4,250', time: '2 ' + t('hours ago'), category: 'alerts', categoryLabel: t('Alerts'), iconBg: 'rgba(249,115,22,.1)', categoryBg: 'rgba(249,115,22,.1)', categoryFg: 'var(--salis-orange)', unread: true },
    { id: 4, icon: 'Package', title: t('Low Stock Alert'), body: t('Brake Pads (Front)') + ' — 18/25 ' + t('In Stock'), time: '3 ' + t('hours ago'), category: 'alerts', categoryLabel: t('Alerts'), iconBg: 'rgba(249,115,22,.1)', categoryBg: 'rgba(249,115,22,.1)', categoryFg: 'var(--salis-orange)', unread: true },
    { id: 5, icon: 'CreditCard', title: t('Payment Received'), body: 'INV-2026-0140 — Omar Al-Ghamdi · SAR 620', time: t('yesterday'), category: 'finance', categoryLabel: t('Finance'), iconBg: 'rgba(10,94,215,.1)', categoryBg: 'rgba(10,94,215,.1)', categoryFg: 'var(--salis-blue)', unread: false },
    { id: 6, icon: 'FileCheck', title: t('Estimate Approved'), body: 'EST-0230 — Mohammed Hassan · SAR 3,600', time: t('yesterday'), category: 'jobs', categoryLabel: t('Job Cards'), iconBg: 'rgba(10,94,215,.1)', categoryBg: 'rgba(10,94,215,.1)', categoryFg: 'var(--salis-blue)', unread: false },
    { id: 7, icon: 'ShieldCheck', title: t('QC Passed'), body: 'JC-C2A9F4E3 — Omar Al-Ghamdi · Hyundai Sonata 2023', time: '2 ' + t('days ago'), category: 'jobs', categoryLabel: t('Job Cards'), iconBg: 'rgba(10,94,215,.1)', categoryBg: 'rgba(10,94,215,.1)', categoryFg: 'var(--salis-blue)', unread: false },
    { id: 8, icon: 'Car', title: t('Vehicle Ready'), body: 'JC-A3F8B2C1 — Ahmed Al-Rashid · Toyota Camry 2022', time: '2 ' + t('days ago'), category: 'jobs', categoryLabel: t('Job Cards'), iconBg: 'rgba(11,179,255,.1)', categoryBg: 'rgba(11,179,255,.1)', categoryFg: 'var(--salis-blue-bright)', unread: false },
  ], [t])
}
