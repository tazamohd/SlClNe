  ...
  return (
    <div className="flex animate-fade-up flex-col gap-6 motion-reduce:animate-none">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-display text-[30px] font-black text-heading">{t('System Tools')}</h1>
          <p className="mt-0.5 text-[13px] text-muted">{t('Administration and maintenance utilities')}</p>
        </div>
      </div>
