  ...
  return (
    <div className="flex animate-fade-up flex-col gap-6 motion-reduce:animate-none">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-display text-[30px] font-black text-heading">{t('Sales Guide')}</h1>
          <p className="mt-0.5 text-[13px] text-muted">{t('Service advisor sales methodology and best practices')}</p>
        </div>
      </div>
            ...
            <div key={step.step} className="flex items-start gap-4 rounded-xl bg-surface-secondary p-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex items-center gap-3">
                  <Badge background="rgba(10,94,215,.1)" color="var(--salis-blue)">{step.duration}</Badge>
