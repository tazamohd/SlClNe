    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-page p-6 font-ui">
      ...
      <div className="relative z-[1] flex max-w-[400px] animate-fade-up flex-col items-center gap-6 text-center">
        ...
        <div className="animate-float">
          <span className="bg-salis-gradient-r bg-clip-text font-display text-[120px] font-black leading-none text-transparent drop-shadow-[0_4px_20px_rgba(10,94,215,.2)]">
            404
          </span>
        </div>
