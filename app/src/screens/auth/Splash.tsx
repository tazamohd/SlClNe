...
export function Splash() {
  ...
  return (
    ...
    <button
      ...
      className="relative flex min-h-viewport w-full cursor-default items-center justify-center overflow-hidden border-none bg-page font-ui focus-visible:ring-2 focus-visible:ring-salis-blue focus-visible:ring-offset-2"
    >
