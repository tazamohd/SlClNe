...
const APP_SCREENS: Record<string, ComponentType> = {
  ...
  'PartsNetwork.Quotations': lazyNamed(() => import('@/screens/network/PartsNetwork'), 'PartsNetworkQuotations'),
  ...
  'PartsNetwork.SendRequest': lazyNamed(() => import('@/screens/network/PartsNetwork'), 'PartsNetworkSendRequest'),
  PartsSupplyNetwork: lazyNamed(() => import('@/screens/network/PartsNetwork'), 'PartsSupplyNetwork'),
