...
const Notifications = lazy(() =>
  import('@/screens/comms/CommunicationScreens').then((m) => ({ default: m.Notifications })),
)
const SMSIntegration = lazy(() =>
  import('@/screens/comms/CommunicationScreens').then((m) => ({ default: m.SMSIntegration })),
)

// compliance
const ComplianceManagement = lazy(() =>
  import('@/screens/compliance/ComplianceScreens').then((m) => ({ default: m.ComplianceManagement })),
)
const ZATCASettings = lazy(() =>
  import('@/screens/compliance/ComplianceScreens').then((m) => ({ default: m.ZATCASettings })),
)
const VATSettings = lazy(() =>
  import('@/screens/compliance/ComplianceScreens').then((m) => ({ default: m.VATSettings })),
)
const ZakatSettings = lazy(() =>
  import('@/screens/compliance/ComplianceScreens').then((m) => ({ default: m.ZakatSettings })),
)
const SafetyIncidents = lazy(() =>
  import('@/screens/compliance/ComplianceScreens').then((m) => ({ default: m.SafetyIncidents })),
)
const EnvironmentalCompliance = lazy(() =>
  import('@/screens/compliance/ComplianceScreens').then((m) => ({ default: m.EnvironmentalCompliance })),
)
const ISOQualityManagement = lazy(() =>
  import('@/screens/compliance/ComplianceScreens').then((m) => ({ default: m.ISOQualityManagement })),
)
const EquipmentCalibration = lazy(() =>
  import('@/screens/compliance/ComplianceScreens').then((m) => ({ default: m.EquipmentCalibration })),
)
...
const SecurityCameras = lazy(() =>
  import('@/screens/infra/InfraScreens').then((m) => ({ default: m.SecurityCameras })),
)
const MobileDeviceManagement = lazy(() =>
  import('@/screens/infra/InfraScreens').then((m) => ({ default: m.MobileDeviceManagement })),
)
const DocumentManagement = lazy(() =>
  import('@/screens/infra/InfraScreens').then((m) => ({ default: m.DocumentManagement })),
)
const DocumentOCR = lazy(() =>
  import('@/screens/infra/InfraScreens').then((m) => ({ default: m.DocumentOCR })),
)
const DataImportExport = lazy(() =>
  import('@/screens/infra/InfraScreens').then((m) => ({ default: m.DataImportExport })),
)
const DataBackup = lazy(() =>
  import('@/screens/infra/InfraScreens').then((m) => ({ default: m.DataBackup })),
)

// settings & admin
const UserProfile = lazy(() =>
  import('@/screens/settings/SettingsScreens').then((m) => ({ default: m.UserProfile })),
)
const SystemSettings = lazy(() =>
  import('@/screens/settings/SettingsScreens').then((m) => ({ default: m.SystemSettings })),
)
const UserSettings = lazy(() =>
  import('@/screens/settings/SettingsScreens').then((m) => ({ default: m.UserSettings })),
)
const SecuritySettings = lazy(() =>
  import('@/screens/settings/SettingsScreens').then((m) => ({ default: m.SecuritySettings })),
)
const RoleManagement = lazy(() =>
  import('@/screens/settings/SettingsScreens').then((m) => ({ default: m.RoleManagement })),
)
...
const DigitalSignage = lazy(() =>
  import('@/screens/productivity/ProductivityScreens').then((m) => ({ default: m.DigitalSignage })),
)

// enterprise
const FranchiseManagement = lazy(() =>
  import('@/screens/enterprise/EnterpriseScreens').then((m) => ({ default: m.FranchiseManagement })),
)
const GlobalizationLayer = lazy(() =>
  import('@/screens/enterprise/EnterpriseScreens').then((m) => ({ default: m.GlobalizationLayer })),
)
const MultiLocationDashboard = lazy(() =>
  import('@/screens/enterprise/EnterpriseScreens').then((m) => ({ default: m.MultiLocationDashboard })),
)
