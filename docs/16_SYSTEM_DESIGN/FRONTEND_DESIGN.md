...
| --- | --- | --- |
| Loading | 200 of 436 | A screen that renders empty while fetching reads as "no data" and is indistinguishable from a real empty result |
| Error | 162 of 436 | A failed fetch with no error state is a blank screen the user cannot act on |
