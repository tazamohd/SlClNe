...
| Measure | Count | Of |
| --- | --- | --- |
| Screens reading the live API | 163 | 436 |
| Screens reading design fixtures | 35 | 436 |
| Rendering | 436 | 436 |
...
| Empty | 267 of 436 | Zero rows is a normal state and needs its own design, not a table with no rows |
