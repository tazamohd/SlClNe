...
| Measure | Count | Of |
| --- | --- | --- |
| Screens reading the live API | 145 | 430 |
| Screens reading design fixtures | 223 | 430 |
| Rendering | 430 | 430 |
...
| --- | --- | --- |
| Loading | 181 of 430 | A screen that renders empty while fetching reads as "no data" and is indistinguishable from a real empty result |
| Error | 145 of 430 | A failed fetch with no error state is a blank screen the user cannot act on |
