...
| Measure | Count | Of |
| --- | --- | --- |
| Screens reading the live API | 99 | 427 |
| Screens reading design fixtures | 288 | 427 |
| Rendering | 427 | 427 |
...
| --- | --- | --- |
| Loading | 143 of 427 | A screen that renders empty while fetching reads as "no data" and is indistinguishable from a real empty result |
| Error | 111 of 427 | A failed fetch with no error state is a blank screen the user cannot act on |
| Empty | 169 of 427 | Zero rows is a normal state and needs its own design, not a table with no rows |
