...
| Measure | Count | Of |
| --- | --- | --- |
| Screens reading the live API | 146 | 436 |
| Screens reading design fixtures | 236 | 436 |
| Rendering | 436 | 436 |
...
| --- | --- | --- |
| Loading | 183 of 436 | A screen that renders empty while fetching reads as "no data" and is indistinguishable from a real empty result |
| Error | 146 of 436 | A failed fetch with no error state is a blank screen the user cannot act on |
