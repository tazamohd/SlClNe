...
| Measure | Count | Of |
| --- | --- | --- |
| Screens reading the live API | 131 | 430 |
| Screens reading design fixtures | 237 | 430 |
| Rendering | 430 | 430 |
...
| --- | --- | --- |
| Loading | 173 of 430 | A screen that renders empty while fetching reads as "no data" and is indistinguishable from a real empty result |
| Error | 138 of 430 | A failed fetch with no error state is a blank screen the user cannot act on |
| Empty | 212 of 430 | Zero rows is a normal state and needs its own design, not a table with no rows |
