...
| Measure | Count | Of |
| --- | --- | --- |
| Screens reading the live API | 159 | 436 |
| Screens reading design fixtures | 39 | 436 |
| Rendering | 436 | 436 |
...
| --- | --- | --- |
| Loading | 192 of 436 | A screen that renders empty while fetching reads as "no data" and is indistinguishable from a real empty result |
| Error | 155 of 436 | A failed fetch with no error state is a blank screen the user cannot act on |
