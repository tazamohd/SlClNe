...
| Measure | Count | Of |
| --- | --- | --- |
| Screens reading the live API | 176 | 436 |
| Screens reading design fixtures | 11 | 436 |
| Rendering | 436 | 436 |
...
| --- | --- | --- |
| Loading | 204 of 436 | A screen that renders empty while fetching reads as "no data" and is indistinguishable from a real empty result |
| Error | 165 of 436 | A failed fetch with no error state is a blank screen the user cannot act on |
