...
| Rendered | 430 | 430 |
| Placeholder | 0 | 430 |
| Data-backed (live API) | 116 | 430 |
| Mock-only (design fixtures) | 251 | 430 |
| End-to-end covered | 430 | 430 |
| Content-asserted (not just routed) | 430 | 430 |
| Has a loading state | 160 | 430 |
| Has an error state | 127 | 430 |
| Has an empty state | 180 | 430 |
