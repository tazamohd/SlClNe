...
| Rendered | 436 | 436 |
| Placeholder | 0 | 436 |
| Data-backed (live API) | 177 | 436 |
| Mock-only (design fixtures) | 10 | 436 |
| End-to-end covered | 436 | 436 |
| Content-asserted (not just routed) | 436 | 436 |
| Has a loading state | 205 | 436 |
| Has an error state | 166 | 436 |
...
| CAP-DESIGNSYSTEM | 198 | 44 | 64 | 38 | 123 | 58 |
