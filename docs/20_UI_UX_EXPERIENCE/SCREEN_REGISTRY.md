...
| Rendered | 436 | 436 |
| Placeholder | 0 | 436 |
| Data-backed (live API) | 163 | 436 |
| Mock-only (design fixtures) | 35 | 436 |
| End-to-end covered | 436 | 436 |
| Content-asserted (not just routed) | 436 | 436 |
| Has a loading state | 195 | 436 |
| Has an error state | 158 | 436 |
| Has an empty state | 267 | 436 |
...
| CAP-DESIGNSYSTEM | 202 | 37 | 59 | 35 | 121 | 57 |
