...
| Rendered | 436 | 436 |
| Placeholder | 0 | 436 |
| Data-backed (live API) | 170 | 436 |
| Mock-only (design fixtures) | 26 | 436 |
| End-to-end covered | 436 | 436 |
| Content-asserted (not just routed) | 436 | 436 |
| Has a loading state | 197 | 436 |
| Has an error state | 159 | 436 |
...
| CAP-DESIGNSYSTEM | 201 | 40 | 60 | 35 | 122 | 60 |
