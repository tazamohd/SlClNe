...
| --- | --- |
| `docs/project-management/planning/` | Release, deployment, migration, training and go-to-market plans |
| `docs/project-management/pmp/wbs.md` | Work breakdown structure |
