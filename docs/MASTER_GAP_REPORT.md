...
|---|---|---|---|---|
| BLK-004 | CRITICAL | 251 rendered capabilities are mock-only | 05 | W2 |
...
| Flag | Count | Meaning |
|---|---|---|
| ARABIC_MISSING | 351 | Arabic not certified: an untranslated key, or keys built dynamically |
| TABLET_MISSING | 308 | no md:/lg: layout in the source — nothing written for 768–1024 |
| MOCK_ONLY | 251 | renders, but from fixtures rather than an API |
| NO_RBAC_MODULE | 196 | no RBAC module maps to this screen |
