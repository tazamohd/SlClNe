...
|---|---|---|---|---|
| BLK-004 | CRITICAL | 24 rendered capabilities are mock-only | 05 | W2 |
...
| Flag | Count | Meaning |
|---|---|---|
| ARABIC_MISSING | 316 | Arabic not certified: an untranslated key, or keys built dynamically |
...
| MOCK_ONLY | 24 | renders, but from fixtures rather than an API |
