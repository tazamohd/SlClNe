...
|---|---|---|---|---|
| BLK-004 | CRITICAL | 35 rendered capabilities are mock-only | 05 | W2 |
...
| NO_RBAC_MODULE | 172 | no RBAC module maps to this screen |
...
| MOCK_ONLY | 35 | renders, but from fixtures rather than an API |
