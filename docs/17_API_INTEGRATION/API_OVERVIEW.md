...
**Status:** GENERATED · **Source of truth:** the route files · **Sources as of:** 2026-09-17

379 endpoints under `/api/v1`, plus the two unauthenticated probes.
...
**138 are written out.** Anything with behaviour of its own: estimates and invoices carry line items, derived money and idempotency; procurement carries approval ceilings; authentication is its own surface.
