...
**Status:** GENERATED · **Sources as of:** 2026-09-14 · 11 endpoints
...
| POST | `/api/v1/estimates/:id/approve` | estimates:a | token | — | — | — | `server/src/routes/estimates.ts` |
...
| POST | `/api/v1/estimates/:id/verify-approval-otp` | estimates:e | token | — | — | — | `server/src/routes/estimate-otp.ts` |
