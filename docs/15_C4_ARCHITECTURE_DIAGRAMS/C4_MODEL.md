...
flowchart TB
  ...
  api["<b>API</b><br/>Fastify 5 on Node<br/>508 endpoints under /api/v1<br/>server/"]
...
flowchart TB
  ...
  subgraph routing[Routing]
    ...
    explicit["166 explicit routes<br/>estimates, invoices, procurement,<br/>HR, insurance, loans, OBD, auth"]
  end
