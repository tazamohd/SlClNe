...
**Status:** GENERATED · **Sources as of:** 2026-09-17 · **Scope:** CURRENT implementation
...
flowchart TB
  ...
  api["<b>API</b><br/>Fastify 5 on Node<br/>379 endpoints under /api/v1<br/>server/"]
...
flowchart TB
  ...
  subgraph routing[Routing]
    ...
    explicit["138 explicit routes<br/>estimates, invoices, procurement,<br/>HR, insurance, loans, OBD, auth"]
  end
