...
flowchart TB
  ...
  api["<b>API</b><br/>Fastify 5 on Node<br/>451 endpoints under /api/v1<br/>server/"]
...
flowchart TB
  ...
  subgraph routing[Routing]
    generic["collections.ts<br/>294 generated routes<br/>from registry.ts"]
    explicit["157 explicit routes<br/>estimates, invoices, procurement,<br/>HR, insurance, loans, OBD, auth"]
  end
