...
| Document | Kind |
| --- | --- |
| [`PRINCE2_REGISTER_VIEWS.md`](PRINCE2_REGISTER_VIEWS.md) | generated |

## Related material not yet migrated

| Where it is now | What it covers |
| --- | --- |
| `docs/project-management/prince2/` | Business case, PID, product descriptions, stage plans, quality register |
