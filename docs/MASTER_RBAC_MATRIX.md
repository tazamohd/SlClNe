...
15 roles × 30 modules, read from `PERMS` in the generated data layer. Actions: v=view, c=create, e=edit, x=delete, a=approve. This is the matrix the app enforces — the server must be asserted equal to it, not written from this page.
