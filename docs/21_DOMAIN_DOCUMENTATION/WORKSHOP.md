...
This domain serves the objective **OBJ-THROUGHPUT** (Increase workshop throughput). It comprises 18 screens, 128 API endpoints and 3 entities, gated by the `jobcards`, `appointments`, `estimates` permission modules.
