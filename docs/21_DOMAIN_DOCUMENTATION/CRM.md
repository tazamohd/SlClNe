...
This domain serves the objective **OBJ-RETENTION** (Retain customers). It comprises 13 screens, 51 API endpoints and 4 entities, gated by the `crm`, `callcenter` permission modules.
