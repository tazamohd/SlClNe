...
**Status:** GENERATED · **Capability:** CAP-CUSTOMERS · **Sources as of:** 2026-09-19

## Purpose and scope

This domain serves the objective **OBJ-RETENTION** (Retain customers). It comprises 4 screens, 20 API endpoints and 2 entities, gated by the `customers` permission module.
