...
| F-010 | `/loyalty-program` | app | **mock** | — | — | yes | verified | yes |
...
| F-032 | `/towing-assistance` | app | **mock** | — | — | yes | verified | yes |
...
| F-054 | `/inventory-management` | app | **mock** | — | — | yes | verified | yes |
...
| F-070 | `/vendor-supplier-portal` | app | **mock** | — | — | yes | verified | yes |
...
| F-118 | `/customer-app-booking` | app | yes | yes | yes | yes | PARTIAL | yes |
...
| F-129 | `/business-intelligence` | app | **mock** | — | — | yes | verified | yes |
| F-130 | `/business-intelligence-dashboard` | app | **mock** | — | — | yes | verified | yes |
| F-131 | `/business-heatmaps` | app | **mock** | — | — | yes | verified | yes |
| F-132 | `/profit-analysis` | app | **mock** | — | — | yes | verified | yes |
| F-133 | `/kpi-dashboard` | app | **mock** | — | — | yes | verified | yes |
...
| F-153 | `/accounts-payable` | app | **mock** | — | — | yes | verified | yes |
...
| F-157 | `/assets-management` | app | **mock** | — | — | yes | verified | yes |
| F-158 | `/liabilities-management` | app | **mock** | — | — | yes | verified | yes |
| F-159 | `/equity-management` | app | yes | yes | yes | yes | PARTIAL | yes |
| F-160 | `/retained-earnings` | app | **mock** | — | — | yes | verified | yes |
| F-161 | `/cost-centers` | app | **mock** | — | — | yes | verified | yes |
| F-162 | `/loss-account` | app | **mock** | — | — | yes | verified | yes |
| F-163 | `/partners-current-account` | app | **mock** | — | — | yes | verified | yes |
...
| F-168 | `/financial-settings` | app | yes | yes | yes | — | PARTIAL | yes |
| F-170 | `/contract-management` | app | **mock** | — | — | yes | verified | yes |
| F-172 | `/marketing-hub` | app | yes | yes | yes | yes | PARTIAL | yes |
| F-173 | `/marketing-automation` | app | **mock** | — | — | yes | verified | yes |
...
| F-189 | `/equipment-calibration` | app | **mock** | — | — | yes | verified | yes |
| F-190 | `/franchise-management` | app | **mock** | — | — | yes | verified | yes |
| F-191 | `/globalization-layer` | app | **mock** | — | — | yes | verified | yes |
| F-192 | `/multi-location-dashboard` | app | **mock** | — | — | yes | verified | yes |
| F-202 | `/emerging-technologies` | app | **mock** | — | — | yes | verified | yes |
| F-203 | `/next-gen-technologies` | app | **mock** | — | — | yes | verified | yes |
...
| F-219 | `/document-management` | app | **mock** | — | — | yes | verified | yes |
...
| F-228 | `/security-settings` | app | yes | yes | yes | — | PARTIAL | yes |
...
| F-235 | `/sales-guide` | app | **mock** | — | — | yes | verified | yes |

## Known gaps in this domain

- **154 of 198 screens read design fixtures rather than the API.** They render and are asserted; they have not exchanged data with the server.
- **134 screens declare neither a loading nor an error state.** Acceptable for a static reference screen; a defect for one that fetches.
