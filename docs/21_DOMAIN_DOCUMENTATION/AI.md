...
| D-AI-Automation | `/ai-automation` | app | **mock** | — | — | yes | verified | yes |
| D-AI-Chatbot | `/ai-chatbot` | app | **mock** | — | — | yes | verified | yes |
| D-AI-Chatbot-Assistant | `/ai-chatbot-assistant` | app | **mock** | — | — | yes | verified | yes |
| D-AI-Service-Advisor | `/ai-service-advisor` | app | **mock** | — | — | yes | verified | yes |
...
| D-ML-Fraud-Detection | `/ml-fraud-detection` | app | **mock** | — | — | yes | verified | yes |
| D-ModelSettings | `/model-settings` | app | **mock** | — | — | yes | PARTIAL | yes |
| D-Neural-Network-Prediction | `/neural-network-prediction` | app | **mock** | — | — | yes | verified | yes |
| D-PromptLibrary | `/prompt-library` | app | **mock** | — | — | yes | PARTIAL | yes |
| D-Smart-Damage-Assessment | `/smart-damage-assessment` | app | **mock** | — | — | yes | verified | yes |
