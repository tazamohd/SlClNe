...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| D-CustomerApp.Appointments | `/customer-app/appointments` | customer-app | yes | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Garage | `/customer-app/garage` | customer-app | yes | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Home | `/customer-app/home` | customer-app | yes | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Insurance | `/customer-app/insurance` | customer-app | yes | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Loans | `/customer-app/loans` | customer-app | yes | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Marketplace | `/customer-app/marketplace` | customer-app | **mock** | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Notifications | `/customer-app/notifications` | customer-app | **mock** | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Orders | `/customer-app/orders` | customer-app | **mock** | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Profile | `/customer-app/profile` | customer-app | **mock** | yes | yes | yes | MISSING | yes |
| D-CustomerApp.ServiceTracking | `/customer-app/service-tracking` | customer-app | yes | yes | yes | yes | MISSING | yes |
| D-CustomerApp.Wallet | `/customer-app/wallet` | customer-app | **mock** | yes | yes | yes | MISSING | yes |
