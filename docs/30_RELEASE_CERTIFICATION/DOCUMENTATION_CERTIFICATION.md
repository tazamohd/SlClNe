...
**Sources as of:** 2026-09-09 · **Score: 81 / 100**
...
| API and data documentation | 10 | 10/10 | All 374 endpoints and all 69 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
