...
| API and data documentation | 10 | 10/10 | All 385 endpoints and all 70 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
