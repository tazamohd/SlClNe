...
| API and data documentation | 10 | 10/10 | All 525 endpoints and all 84 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
