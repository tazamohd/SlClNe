...
| API and data documentation | 10 | 10/10 | All 497 endpoints and all 81 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
