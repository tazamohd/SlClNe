...
| API and data documentation | 10 | 10/10 | All 407 endpoints and all 72 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
