...
| API and data documentation | 10 | 10/10 | All 449 endpoints and all 77 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
