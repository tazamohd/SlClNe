...
| API and data documentation | 10 | 10/10 | All 303 endpoints and all 68 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
