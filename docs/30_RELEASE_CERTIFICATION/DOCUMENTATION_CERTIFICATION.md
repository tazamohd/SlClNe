...
| API and data documentation | 10 | 10/10 | All 508 endpoints and all 82 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
