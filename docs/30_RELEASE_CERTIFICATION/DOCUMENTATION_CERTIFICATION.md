...
**Sources as of:** 2026-09-15 · **Score: 81 / 100**
...
| API and data documentation | 10 | 10/10 | All 372 endpoints and all 68 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
