...
| API and data documentation | 10 | 10/10 | All 431 endpoints and all 75 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
