...
| API and data documentation | 10 | 10/10 | All 423 endpoints and all 73 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
