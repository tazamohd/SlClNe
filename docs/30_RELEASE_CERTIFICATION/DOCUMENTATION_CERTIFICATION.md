...
| API and data documentation | 10 | 10/10 | All 446 endpoints and all 76 entities documented from source, with guards, scopes, query contracts and the FK caveat stated. |
