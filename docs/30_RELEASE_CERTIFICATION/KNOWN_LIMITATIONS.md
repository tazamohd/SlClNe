...
| L-06 | 261 endpoints have no test matched to them by path | Over-reports (helpers and golden paths do not match), but the write endpoints among them are real exposure | `project-control/API_REGISTRY.json` |
