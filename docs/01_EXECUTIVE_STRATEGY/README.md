...
| Document | Kind |
| --- | --- |
| [`EXECUTIVE_SUMMARY.md`](EXECUTIVE_SUMMARY.md) | authored |

## Related material not yet migrated

| Where it is now | What it covers |
| --- | --- |
| `docs/management/strategic-plan.md` | Strategic plan |
| `docs/management/business-plan.md` | Business plan |
| `docs/management/financial-plan.md` | Financial plan |
