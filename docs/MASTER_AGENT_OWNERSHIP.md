...
| 15 | AI / Automation | product | 14 | `app/src/screens/ai/**`<br>`app/src/screens/crm/Crm.tsx`<br>`app/src/screens/domains/ai.ts` |
...
| 17 | Public Website & Landing | product | 39 | `app/src/screens/public/**`<br>`app/src/components/shell/PublicShell.tsx`<br>`app/public/robots.txt`<br>`app/public/sitemap.xml`<br>`app/src/screens/domains/website.ts` |
| 25 | System Administration | product | — | `app/src/screens/admin/**`<br>`app/src/screens/domains/admin.ts` |
