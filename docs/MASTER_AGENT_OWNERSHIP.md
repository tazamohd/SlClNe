...
| 17 | Public Website & Landing | product | 34 | `app/src/screens/public/**`<br>`app/src/components/shell/PublicShell.tsx`<br>`app/public/robots.txt`<br>`app/public/sitemap.xml`<br>`app/src/screens/domains/website.ts` |
