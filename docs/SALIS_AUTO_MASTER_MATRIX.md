...
436 capabilities · 436 rendering · 0 placeholder · 168 data-backed.
...
| HealthCheckReport | `/customer-portal/health-check-report` | app | jobcards | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 11 roles | route | IMPLEMENTED |
...
| Technician Leaderboards | `/technician-leaderboards` | app | hr | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | 6 roles | route | IMPLEMENTED |
...
| ZATCA Settings | `/zatca-settings` | app | — | DONE | MISSING | PARTIAL | VERIFIED | PARTIAL | DONE | — | route | IMPLEMENTED |
