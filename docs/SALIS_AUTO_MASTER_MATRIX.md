<!-- GENERATED by app/scripts/build-registry.mjs on 2026-09-12. Do not edit by hand. -->

# SALIS AUTO — Master Capability Matrix

425 capabilities · 425 rendering · 0 placeholder · 99 data-backed.
...
| AgentRegistry | `/agent-registry` | app | ai | DONE | PARTIAL | DONE | PARTIAL | PARTIAL | DONE | 6 roles | route | IMPLEMENTED |
...
| AutomationRules | `/automation-rules` | app | ai | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 6 roles | route | IMPLEMENTED |
...
| ConversationHistory | `/conversation-history` | app | ai | DONE | PARTIAL | DONE | PARTIAL | PARTIAL | DONE | 6 roles | route | IMPLEMENTED |
...
| ModelSettings | `/model-settings` | app | ai | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 6 roles | route | IMPLEMENTED |
...
| Organizations | `/organizations` | app | admin | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 4 roles | route | IMPLEMENTED |
...
| RolesPermissions | `/roles-permissions` | app | admin | DONE | PARTIAL | DONE | PARTIAL | PARTIAL | MISSING | 4 roles | route | IMPLEMENTED |
...
| SuperAdmin | `/super-admin` | app | settings | DONE | MISSING | DONE | VERIFIED | PARTIAL | MISSING | 4 roles | route | IMPLEMENTED |
...
| WorkflowBuilder | `/workflow-builder` | app | ai | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 6 roles | route | IMPLEMENTED |
