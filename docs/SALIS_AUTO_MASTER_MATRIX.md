...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| AccountLocked | `/account-locked` | auth | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| AdvancedSettings | `/advanced-settings` | app | settings | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 3 roles | route | IMPLEMENTED |
| AgentDashboard | `/agent-dashboard` | app | ai | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
| AgentRegistry | `/agent-registry` | app | ai | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
...
| BIDashboard | `/bidashboard` | app | execreports | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 4 roles | route | IMPLEMENTED |
| BiometricSetup | `/biometric-setup` | auth | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| Campaigns | `/campaigns` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
| ChartOfAccounts | `/chart-of-accounts` | app | accounting | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 4 roles | route | IMPLEMENTED |
| ConversationHistory | `/conversation-history` | app | ai | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
| CookiePolicy | `/cookie-policy` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| CreatePIN | `/create-pin` | auth | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| CRMCalendar | `/crmcalendar` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
| CRMTasks | `/crmtasks` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
...
| CustomerApproval | `/customer-approval` | app | estimates | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | 9 roles | route | IMPLEMENTED |
...
| Customers | `/customers` | app | customers | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 8 roles | route | IMPLEMENTED |
| CustomerSegments | `/customer-segments` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
| CustomReports | `/custom-reports` | app | reports | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 9 roles | route | IMPLEMENTED |
| Dashboard | `/dashboard` | app | dashboard | DONE | MISSING | MISSING | PARTIAL | PARTIAL | DONE | 12 roles | route | IMPLEMENTED |
| Departments | `/departments` | app | hr | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
| DiagnosticReport | `/diagnostic-report` | app | jobcards | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | 10 roles | route | IMPLEMENTED |
| EmailMarketing | `/email-marketing` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
...
| ExecutiveReports | `/executive-reports` | app | execreports | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 4 roles | route | IMPLEMENTED |
| Expenses | `/expenses` | app | accounting | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 4 roles | route | IMPLEMENTED |
| FinancialReports | `/financial-reports` | app | accounting | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 4 roles | route | IMPLEMENTED |
| FinancialStatements | `/financial-statements` | app | accounting | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 4 roles | route | IMPLEMENTED |
...
| ForgotPassword | `/forgot-password` | auth | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| Index | `/index` | reference | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| InsuranceReports | `/insurance-reports` | app | execreports | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 4 roles | route | IMPLEMENTED |
| Integrations | `/integrations` | app | admin | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 3 roles | route | IMPLEMENTED |
...
| InvoicePreview | `/invoice-preview` | app | invoices | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 7 roles | route | IMPLEMENTED |
| Invoices | `/invoices` | app | invoices | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 7 roles | route | IMPLEMENTED |
| JobCardDetail | `/job-card-detail` | app | jobcards | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 10 roles | route | IMPLEMENTED |
...
| LeadPipeline | `/lead-pipeline` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
...
| LogoutConfirmation | `/logout-confirmation` | auth | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| Maintenance | `/maintenance` | auth | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| OBDDiagnostics | `/obddiagnostics` | app | jobcards | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | 10 roles | route | IMPLEMENTED |
...
| OperationalReports | `/operational-reports` | app | reports | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 9 roles | route | IMPLEMENTED |
| Opportunities | `/opportunities` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
...
| OTPVerification | `/otpverification` | auth | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| Payments | `/payments` | app | payments | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 6 roles | route | IMPLEMENTED |
| PrivacyPolicy | `/privacy-policy` | auth | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| PublicPortal · CustomerPortal | `/public-portal/customer-portal` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · FAQ | `/public-portal/faq` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · Features | `/public-portal/features` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · Fleet | `/public-portal/fleet` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · Industries | `/public-portal/industries` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · Insurance | `/public-portal/insurance` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · Integrations | `/public-portal/integrations` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| PublicPortal · MiniERP | `/public-portal/mini-erp` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| PublicPortal · SupplierPortal | `/public-portal/supplier-portal` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · Support | `/public-portal/support` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · TechnicianPortal | `/public-portal/technician-portal` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| PublicPortal · Workshop | `/public-portal/workshop` | public | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| Reports | `/reports` | app | reports | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 9 roles | route | IMPLEMENTED |
| ReportsAnalytics | `/reports-analytics` | app | reports | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 9 roles | route | IMPLEMENTED |
| ResetPassword | `/reset-password` | auth | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| SalesReports | `/sales-reports` | app | execreports | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 4 roles | route | IMPLEMENTED |
| SessionExpired | `/session-expired` | auth | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| Settings | `/settings` | app | settings | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 3 roles | route | IMPLEMENTED |
| SMSCampaigns | `/smscampaigns` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
| SocialLogin | `/social-login` | auth | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| Splash | `/splash` | auth | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| TechnicianSchedule | `/technician-schedule` | app | technicians | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 8 roles | route | IMPLEMENTED |
| Templates | `/templates` | app | admin | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 3 roles | route | IMPLEMENTED |
| TermsConditions | `/terms-conditions` | auth | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| TwoFactorVerification | `/two-factor-verification` | auth | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| UI · ActivityFeed | `/ui/activity-feed` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · AdvancedFilters | `/ui/advanced-filters` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Attachments | `/ui/attachments` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · CalendarView | `/ui/calendar-view` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · CardView | `/ui/card-view` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Charts | `/ui/charts` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Comments | `/ui/comments` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · EmptyStates | `/ui/empty-states` | reference | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · ExportCenter | `/ui/export-center` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · FormValidation | `/ui/form-validation` | reference | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · ImportCenter | `/ui/import-center` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · KanbanView | `/ui/kanban-view` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · ListView | `/ui/list-view` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · LoadingStates | `/ui/loading-states` | reference | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · MapView | `/ui/map-view` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · MediaGallery | `/ui/media-gallery` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Messages | `/ui/messages` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Modals · Actions | `/ui/modals/actions` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Modals · Capture | `/ui/modals/capture` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Modals · CRUD | `/ui/modals/crud` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Modals · Data | `/ui/modals/data` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Modals · Lifecycle | `/ui/modals/lifecycle` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · Modals · Status | `/ui/modals/status` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · TableView | `/ui/table-view` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| UI · TimelineView | `/ui/timeline-view` | reference | — | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | REFERENCE_ONLY |
| Unauthorized | `/unauthorized` | auth | ungated | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| WhatsAppCampaigns | `/whats-app-campaigns` | app | crm | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 5 roles | route | IMPLEMENTED |
| WorkflowBuilder | `/workflow-builder` | app | ai | DONE | MISSING | DONE | PARTIAL | PARTIAL | MISSING | 5 roles | route | IMPLEMENTED |
| WorkshopCheckIn | `/workshop-check-in` | app | jobcards | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 10 roles | route | IMPLEMENTED |
...
| WorkshopQC | `/workshop-qc` | app | jobcards | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 10 roles | route | IMPLEMENTED |
| WorkshopReports | `/workshop-reports` | app | reports | DONE | MISSING | DONE | PARTIAL | PARTIAL | DONE | 9 roles | route | IMPLEMENTED |
...
| Dashboard Home | `/dashboard-home` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | — | route | IMPLEMENTED |
| Welcome Page | `/welcome-page` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| Dashboard Main | `/dashboard-main` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | — | route | IMPLEMENTED |
| Customers List | `/customers-list` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | — | route | IMPLEMENTED |
...
| Vehicles List | `/vehicles-list` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | — | route | IMPLEMENTED |
...
| Purchase Agent Suppliers | `/purchase-agent-suppliers` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | — | route | IMPLEMENTED |
...
| Technician Portal Profile | `/technician-portal-profile` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| Technician App Home | `/technician-app-home` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| Technician App Profile | `/technician-app-profile` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| Client Portal Invoices | `/client-portal-invoices` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | — | route | IMPLEMENTED |
| Client Portal Profile | `/client-portal-profile` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
...
| Client Portal Review Chat | `/client-portal-review-chat` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| Customer App Booking | `/customer-app-booking` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | MISSING | — | route | IMPLEMENTED |
| Customer App Vehicles | `/customer-app-vehicles` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | — | route | IMPLEMENTED |
...
| Portal Invoices | `/portal-invoices` | app | — | DONE | MISSING | PARTIAL | PARTIAL | PARTIAL | DONE | — | route | IMPLEMENTED |
