...
| Document | Kind |
| --- | --- |
| [`TEST_CATALOG.md`](TEST_CATALOG.md) | generated |

## Related material not yet migrated

| Where it is now | What it covers |
| --- | --- |
| `docs/testing/` | Load, security, regression and UAT test plans |
| `docs/system/testing-strategy.md` | Testing strategy |
| `docs/MASTER_TEST_STRATEGY.md` | Master test strategy |
