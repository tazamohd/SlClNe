...
230 spec files containing 2526 test cases.
...
| --- | --- | --- | --- |
| UNIT_OR_API | 155 | 1416 | Handler behaviour, repository seam, presentation |
...
| `app/tests/component/customer-app-booking-entry.test.tsx` | UNIT_OR_API | 2 | customer |
