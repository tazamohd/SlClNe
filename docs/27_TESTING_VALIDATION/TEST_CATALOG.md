...
200 spec files containing 2270 test cases.
...
| --- | --- | --- | --- |
| UNIT_OR_API | 125 | 1160 | Handler behaviour, repository seam, presentation |
...
| `app/tests/screen-seam-wiring.test.tsx` | UNIT_OR_API | 13 | owner, accountant |
