...
| ENT-BRANCHES | `branches` | 13 | yes | yes | yes | yes | yes | yes | — | 2 |
| ENT-USERS | `users` | 18 | yes | yes | yes | yes | yes | yes | — | 0 |
| ENT-USER-SESSIONS | `user_sessions` | 17 | yes | yes | yes | yes | yes | yes | — | 0 |
| ENT-FLEETS | `fleets` | 21 | yes | yes | yes | yes | yes | yes | 1 | 6 |
| ENT-CUSTOMERS | `customers` | 19 | yes | yes | yes | yes | yes | yes | 1 | 6 |
| ENT-VEHICLES | `vehicles` | 18 | yes | yes | yes | yes | yes | yes | — | 6 |
| ENT-SERVICES | `services` | 11 | yes | yes | yes | yes | yes | yes | — | 2 |
| ENT-JOB-CARDS | `job_cards` | 21 | yes | yes | yes | yes | yes | yes | — | 0 |
| ENT-APPOINTMENTS | `appointments` | 23 | yes | yes | yes | yes | yes | yes | — | 6 |
| ENT-ESTIMATES | `estimates` | 25 | yes | yes | yes | yes | yes | yes | 4 | 2 |
| ENT-ESTIMATE-LINES | `estimate_lines` | 17 | yes | yes | yes | yes | yes | yes | 1 | 0 |
| ENT-INVOICES | `invoices` | 28 | yes | yes | yes | yes | yes | yes | 5 | 2 |
| ENT-INVOICE-LINES | `invoice_lines` | 17 | yes | yes | yes | yes | yes | yes | 1 | 0 |
| ENT-PAYMENTS | `payments` | 16 | yes | yes | yes | yes | yes | yes | 1 | 2 |
| ENT-RECEIPTS | `receipts` | 16 | yes | yes | yes | yes | yes | yes | 1 | 2 |
| ENT-PARTS | `parts` | 17 | yes | yes | yes | yes | yes | yes | 2 | 6 |
| ENT-INVENTORY-MOVEMENTS | `inventory_movements` | 17 | yes | yes | yes | yes | yes | yes | — | 0 |
| ENT-SUPPLIERS | `suppliers` | 17 | yes | yes | yes | yes | yes | yes | — | 6 |
| ENT-REQUISITIONS | `requisitions` | 20 | yes | yes | yes | yes | yes | yes | 1 | 2 |
...
| ENT-TECHNICIANS | `technicians` | 14 | yes | yes | yes | yes | yes | yes | — | 2 |
| ENT-DEPARTMENTS | `departments` | 15 | yes | yes | yes | yes | yes | yes | — | 2 |
| ENT-LEADS | `leads` | 17 | yes | yes | yes | yes | yes | yes | 1 | 6 |
| ENT-OPPORTUNITIES | `opportunities` | 16 | yes | yes | yes | yes | yes | yes | 1 | 6 |
| ENT-CAMPAIGNS | `campaigns` | 18 | yes | yes | yes | yes | yes | yes | 2 | 2 |
| ENT-SEGMENTS | `segments` | 13 | yes | yes | yes | yes | yes | yes | — | 2 |
...
| ENT-EXPENSES | `expenses` | 15 | yes | yes | yes | yes | yes | yes | 1 | 2 |
...
| ENT-EMPLOYEES | `employees` | 17 | yes | yes | yes | yes | yes | yes | 1 | 6 |
...
| ENT-TIMESHEETS | `timesheets` | 16 | yes | yes | yes | yes | yes | yes | — | 6 |
...
| ENT-INTEGRATIONS | `integrations` | 16 | yes | yes | yes | yes | yes | yes | — | 2 |
...
| ENT-CONVERSATIONS | `conversations` | 14 | yes | yes | yes | yes | yes | yes | — | 2 |
