...
| REL-WAREHOUSE-ZONES-ORG-ID | `warehouse_zones` | `org_id` | `organizations` | many-to-one | mandatory | DECLARED (FK) | yes |
| REL-WAREHOUSE-ZONES-BRANCH-ID | `warehouse_zones` | `branch_id` | `branches` | many-to-one | optional | **INFERRED** | yes |
