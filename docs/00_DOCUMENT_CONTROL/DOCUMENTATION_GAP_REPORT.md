...
| Screens wired to the live API | 125 of 429 |
...
### 5. 241 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 241 of 429 are not yet connected to live data.
...
6. **Connect the remaining 241 screens to the API**, which is the bulk of the product work still outstanding.
