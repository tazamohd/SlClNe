...
| Endpoints documented | 509 of 509 |
| Endpoints with a linked test | 137 of 509 |
...
| Screens wired to the live API | 165 of 436 |
| Test suites catalogued | 217 containing 2447 cases |
...
### 5. 33 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 33 of 436 are not yet connected to live data.
...
6. **Connect the remaining 33 screens to the API**, which is the bulk of the product work still outstanding.
