...
| Screens wired to the live API | 104 of 425 |
| Test suites catalogued | 187 containing 2183 cases |
...
### 5. 281 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 281 of 425 are not yet connected to live data.
