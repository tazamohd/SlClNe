...
| Screens wired to the live API | 128 of 429 |
| Test suites catalogued | 197 containing 2252 cases |
...
### 5. 238 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 238 of 429 are not yet connected to live data.
...
6. **Connect the remaining 238 screens to the API**, which is the bulk of the product work still outstanding.
