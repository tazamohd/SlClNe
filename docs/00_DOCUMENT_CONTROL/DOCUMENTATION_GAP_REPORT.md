...
| Test suites catalogued | 226 containing 2498 cases |
...
### 5. 25 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 25 of 436 are not yet connected to live data.
...
6. **Connect the remaining 25 screens to the API**, which is the bulk of the product work still outstanding.
