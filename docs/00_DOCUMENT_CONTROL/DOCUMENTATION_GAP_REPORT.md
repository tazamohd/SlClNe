...
| Screens wired to the live API | 119 of 430 |
| Test suites catalogued | 200 containing 2270 cases |
...
### 5. 248 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 248 of 430 are not yet connected to live data.
...
6. **Connect the remaining 248 screens to the API**, which is the bulk of the product work still outstanding.
