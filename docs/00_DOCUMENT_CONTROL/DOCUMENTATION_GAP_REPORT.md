...
| Endpoints documented | 449 of 449 |
| Endpoints with a linked test | 120 of 449 |
...
| Screens wired to the live API | 145 of 430 |
| Test suites catalogued | 206 containing 2321 cases |
...
### 4. 329 endpoints have no test matched to them by path
...
### 5. 223 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 223 of 430 are not yet connected to live data.
...
6. **Connect the remaining 223 screens to the API**, which is the bulk of the product work still outstanding.
