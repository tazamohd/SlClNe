...
| Screens wired to the live API | 131 of 430 |
| Test suites catalogued | 202 containing 2291 cases |
...
Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 237 of 430 are not yet connected to live data.
