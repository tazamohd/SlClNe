...
| Screens wired to the live API | 170 of 436 |
| Test suites catalogued | 225 containing 2493 cases |
...
### 5. 26 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 26 of 436 are not yet connected to live data.
...
6. **Connect the remaining 26 screens to the API**, which is the bulk of the product work still outstanding.
