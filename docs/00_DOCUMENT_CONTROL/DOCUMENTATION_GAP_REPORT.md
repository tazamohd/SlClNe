...
| Screens wired to the live API | 166 of 436 |
| Test suites catalogued | 219 containing 2447 cases |
...
### 5. 30 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 30 of 436 are not yet connected to live data.
...
6. **Connect the remaining 30 screens to the API**, which is the bulk of the product work still outstanding.
