...
| Screens wired to the live API | 176 of 436 |
| Test suites catalogued | 231 containing 2537 cases |
...
### 5. 11 screens read design fixtures rather than the API

Measured in `project-control/STATUS.json`, not asserted here. Every screen renders and every screen has a content assertion — and 11 of 436 are not yet connected to live data.
...
6. **Connect the remaining 11 screens to the API**, which is the bulk of the product work still outstanding.
