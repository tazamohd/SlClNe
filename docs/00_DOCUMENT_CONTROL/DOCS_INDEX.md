...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 440-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 440 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 204 suites, 2305 cases | the spec files |
