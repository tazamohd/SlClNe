...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 423-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 423 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 199 suites, 2266 cases | the spec files |
