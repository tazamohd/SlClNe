...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 509-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 509 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 216 suites, 2445 cases | the spec files |
