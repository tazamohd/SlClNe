...
**Sources as of:** 2026-09-09 · 408 documents, 139 in the numbered architecture
...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 374-endpoint surface and its cross-cutting contract |
...
| `project-control/TEST_REGISTRY.json` | 182 suites, 2144 cases | the spec files |
