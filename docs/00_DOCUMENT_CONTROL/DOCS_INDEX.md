...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 527-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 527 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 226 suites, 2495 cases | the spec files |
