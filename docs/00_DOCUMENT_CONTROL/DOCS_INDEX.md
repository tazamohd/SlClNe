...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 525-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 525 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 219 suites, 2476 cases | the spec files |
