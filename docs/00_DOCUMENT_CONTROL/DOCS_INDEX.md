...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 431-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 431 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 202 suites, 2292 cases | the spec files |
