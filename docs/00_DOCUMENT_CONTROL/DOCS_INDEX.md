...
**Sources as of:** 2026-09-18 · 411 documents, 141 in the numbered architecture
...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 390-endpoint surface and its cross-cutting contract |
...
| `17_API_INTEGRATION/` | The API surface, per domain, generated from the routers. | 24 |
...
| `project-control/API_REGISTRY.json` | 390 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 192 suites, 2228 cases | the spec files |
...
| `project-control/MASTER_REGISTRY.json` | 433 screens — **owned by `app/scripts/build-registry.mjs`, not by this system** | the screen sources |
