...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 528-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 528 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 229 suites, 2524 cases | the spec files |
