...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 425-endpoint surface and its cross-cutting contract |
...
| --- | --- | --- |
| `project-control/ENTITY_REGISTRY.json` | 75 tables with every column | `server/src/db/schema.ts` |
| `project-control/RELATIONSHIP_REGISTRY.json` | 192 relationships, declared versus inferred | `server/src/db/schema.ts` |
| `project-control/API_REGISTRY.json` | 425 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 200 suites, 2268 cases | the spec files |
