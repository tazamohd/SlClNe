...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 449-endpoint surface and its cross-cutting contract |
...
| --- | --- | --- |
| `project-control/ENTITY_REGISTRY.json` | 77 tables with every column | `server/src/db/schema.ts` |
| `project-control/RELATIONSHIP_REGISTRY.json` | 196 relationships, declared versus inferred | `server/src/db/schema.ts` |
| `project-control/API_REGISTRY.json` | 449 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 206 suites, 2321 cases | the spec files |
