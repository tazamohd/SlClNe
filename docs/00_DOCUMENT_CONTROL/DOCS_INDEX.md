...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 460-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 460 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 210 suites, 2357 cases | the spec files |
