...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 497-endpoint surface and its cross-cutting contract |
...
| --- | --- | --- |
| `project-control/ENTITY_REGISTRY.json` | 81 tables with every column | `server/src/db/schema.ts` |
| `project-control/RELATIONSHIP_REGISTRY.json` | 205 relationships, declared versus inferred | `server/src/db/schema.ts` |
| `project-control/API_REGISTRY.json` | 497 endpoints with guards and scopes | the route files |
...
| `project-control/STATE_MACHINE_REGISTRY.json` | 25 lifecycles | `packages/contract/src/entities/*.ts` |
| `project-control/TEST_REGISTRY.json` | 212 suites, 2409 cases | the spec files |
