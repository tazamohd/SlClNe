...
**Sources as of:** 2026-09-18 · 410 documents, 139 in the numbered architecture
...
| `project-control/TEST_REGISTRY.json` | 193 suites, 2231 cases | the spec files |
...
| `project-control/MASTER_REGISTRY.json` | 428 screens — **owned by `app/scripts/build-registry.mjs`, not by this system** | the screen sources |
