...
**Sources as of:** 2026-09-19 · 410 documents, 139 in the numbered architecture
...
| [API overview](../17_API_INTEGRATION/API_OVERVIEW.md) | The 445-endpoint surface and its cross-cutting contract |
...
| `project-control/API_REGISTRY.json` | 445 endpoints with guards and scopes | the route files |
...
| `project-control/TEST_REGISTRY.json` | 206 suites, 2320 cases | the spec files |
