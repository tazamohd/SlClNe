...
### Endpoints with no linked test (325 of 445)
...
_…and 265 more. The full list is in `project-control/API_REGISTRY.json` — every endpoint whose `tests` array is empty._
