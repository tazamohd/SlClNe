...
### Endpoints with no linked test (280 of 390)
...
_…and 220 more. The full list is in `project-control/API_REGISTRY.json` — every endpoint whose `tests` array is empty._
