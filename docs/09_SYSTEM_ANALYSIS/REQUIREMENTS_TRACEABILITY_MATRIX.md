...
| OBJ-CONTROL | CAP-PLATFORM | FR-PLATFORM-001 | 4 | 24 | 14 | 35 | 0 | 7 |
...
### Endpoints with no linked test (326 of 446)
...
_…and 266 more. The full list is in `project-control/API_REGISTRY.json` — every endpoint whose `tests` array is empty._
