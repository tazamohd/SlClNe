...
| FR-DESIGNSYSTEM-001 | The system provides design system and reference surfaces through 201 screens and 0 API endpoints, gated by the domain permission modules. | CAP-DESIGNSYSTEM | — | 201 | `project-control/CAPABILITY_REGISTRY.json` |
...
| NFR-I18N-001 | Arabic and RTL are verified per screen, and RTL hazards are held at zero. | project-control/STATUS.json — arabicVerified 121 of 436, rtlHazards 0 | MEASURED_REGISTRY |
