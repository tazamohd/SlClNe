...
**Status:** GENERATED · **Sources as of:** 2026-09-19 · 163 requirements
...
| FR-PLATFORM-001 | The system provides administration and platform through 35 screens and 24 API endpoints, gated by the `admin`, `departments`, `settings`, `superadmin`, `dashboard`, `network`, `ungated`, `platform` permission modules. | CAP-PLATFORM | 24 | 35 | `project-control/CAPABILITY_REGISTRY.json` |
...
| NFR-I18N-001 | Arabic and RTL are verified per screen, and RTL hazards are held at zero. | project-control/STATUS.json — arabicVerified 75 of 436, rtlHazards 0 | MEASURED_REGISTRY |
