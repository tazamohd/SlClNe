...
| --- | --- |
| `docs/marketing/` | Sales playbook, demo script, press kit, partnership programme, case study template |
| `docs/project-management/planning/customer-success-plan.md` | Customer success plan |
