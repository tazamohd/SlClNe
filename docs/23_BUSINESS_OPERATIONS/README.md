...
| --- | --- |
| `docs/departments/` | Six departmental operating documents |
| `docs/training/` | Fourteen role-based training courses |
| `docs/knowledge-base/library/standard-operating-procedures.md` | Standard operating procedures |
